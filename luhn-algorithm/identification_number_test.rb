...
require_relative 'identification_number'

# Common test data version: 1.4.0 4a80663
class IdentificationNumberTest < Minitest::Test
  def test_nil_can_not_be_valid
  ...
  def test_more_than_a_single_zero_is_valid
    assert IdentificationNumber.valid?("0000 0")
  end

  def test_input_digit_9_is_correctly_converted_to_output_digit_9
    assert IdentificationNumber.valid?("091")
  end

  def test_strings_with_non_digits_is_invalid
    refute IdentificationNumber.valid?(":9")
  end
end
